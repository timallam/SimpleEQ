...
SimpleEQAudioProcessor::createParameterLayout()
{
    ...
    layout.add(std::make_unique<juce::AudioParameterFloat>(
                                                          common_decl::LOW_CUT_FREQUENCY,
                                                          common_decl::LOW_CUT_FREQUENCY,
                                                          juce::NormalisableRange<float>(20.f, 20000.f, 1.f, 1.f),
                                                          20.f));
          
    layout.add(std::make_unique<juce::AudioParameterFloat>(
                                                          common_decl::HIGH_CUT_FREQUENCY,
                                                          common_decl::HIGH_CUT_FREQUENCY,
                                                          juce::NormalisableRange<float>(20.f, 20000.f, 1.f, 1.f),
                                                          20000.f));
    
    layout.add(std::make_unique<juce::AudioParameterFloat>(
                                                          common_decl::PEAK_FREQUENCY,
                                                          common_decl::PEAK_FREQUENCY,
                                                          juce::NormalisableRange<float>(20.f, 20000.f, 1.f, 1.f),
                                                          750.f));
    
    layout.add(std::make_unique<juce::AudioParameterFloat>(
                                                          common_decl::PEAK_GAIN,
                                                          common_decl::PEAK_GAIN,
                                                          juce::NormalisableRange<float>(-24.f, 24.f, 0.5f, 1.f),
                                                          0.0f));
    
    layout.add(std::make_unique<juce::AudioParameterFloat>(
                                                          common_decl::PEAK_QUALITY,
                                                          common_decl::PEAK_QUALITY,
    ...
    layout.add(std::make_unique<juce::AudioParameterChoice>(common_decl::LOW_CUT_SLOPE, common_decl::LOW_CUT_SLOPE, stringArray, 0));
    
    layout.add(std::make_unique<juce::AudioParameterChoice>(common_decl::HIGH_CUT_SLOPE, common_decl::HIGH_CUT_SLOPE, stringArray, 0));
